...
class Primitive(RedisDataType):
    ...
    def __setitem__(self, i, val):
        return self._client.setrange(self.key, i, val)

    def __getitem__(self, i):
        return self._client.getrange(self.key, i, i)

    def __getslice__(self, i, j):
        return self._client.getrange(self.key, i, j)

    def __setslice__(self, i, val):
        return self._client.setrange(self.key, i, val)
